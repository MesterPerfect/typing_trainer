...
class ResultsView(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.table.setHorizontalHeaderLabels(["Date", "Lesson", "WPM", "Accuracy", "Errors"])
    ...
    def load_results(self):
        ...
        lessons = {str(lvl.id): lvl.title for lvl in self.lesson_loader.load_all_lessons()}
        ...
        try:
            ...
            for row_idx, item in enumerate(data):
                ...
                # Format Date
                date_str = datetime.fromtimestamp(item.get("timestamp", 0)).strftime("%Y-%m-%d %H:%M")
